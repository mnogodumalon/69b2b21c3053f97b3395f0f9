...
const PERSONEN_FIELDS = [
  { key: 'ist_aktiv', label: 'Ist aktiv?', type: 'bool' },
  { key: 'status', label: 'Status', type: 'lookup/select', options: [{ key: 'aktiv', label: 'Aktiv' }, { key: 'inaktiv', label: 'Inaktiv' }, { key: 'gesperrt', label: 'Gesperrt' }] },
  { key: 'profilbild', label: 'Profilbild', type: 'file' },
  { key: 'standort', label: 'Standort', type: 'geo' },
  { key: 'mitarbeiter_nummer', label: 'Mitarbeiter-Nummer', type: 'number' },
  ...
  { key: 'kategorie', label: 'Kategorie', type: 'applookup/choice', targetEntity: 'kategorien', targetAppId: 'KATEGORIEN', displayField: 'kategoriename' },
];
...
export default function AdminPage() {
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'personen' && fieldKey === 'kategorie') {
