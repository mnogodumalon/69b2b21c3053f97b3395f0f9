...
import { LayoutDashboard, Menu, Settings, Tag, Undo2, Users } from 'lucide-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';

// ⚡ Customize these for your app
const APP_TITLE = 'Personenverwaltung';
...
const navigation = [
  ...
  { name: 'Personen', href: '/personen', icon: Users },
];

const externalNavigation = [
  { name: 'Kategorien', href: '/gateway/apps/69b2b205010fa763ed3868da?template=list_page', icon: Tag },
  { name: 'Personen', href: '/gateway/apps/69b2b20d0f2d44b284d757fc?template=list_page', icon: Users },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69b2b205010fa763ed3868da?template=list_page"
          ...
          {/* CRUD page links (hidden, reactivate via CSS) */}
